...
def evaluate_models():
    ...
    percent_error = np.abs(pred_ensemble - y_test) / y_test
    ...
    print(f"Ensemble RMSE: {rmse:.2f} mins")
    print(f"Ensemble MAE: {mae:.2f} mins")
